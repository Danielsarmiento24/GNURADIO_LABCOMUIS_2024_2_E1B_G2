...
class Practica2_ParteB_Punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_add_const_vxx_1 = blocks.add_const_ff((-(math.pow(2,n)-1)/2))
        ...
        self.connect((self.blocks_multiply_const_vxx_2, 0), (self.blocks_throttle2_1, 0))
    ...
    def set_n(self, n):
        self.n = n
        self.blocks_add_const_vxx_1.set_k((-(math.pow(2,self.n)-1)/2))
