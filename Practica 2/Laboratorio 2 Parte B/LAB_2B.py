...
class LAB_2B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "parte_2", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "LAB_2B")
...
def main(top_block_cls=LAB_2B, options=None):
