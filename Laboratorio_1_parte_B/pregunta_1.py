...
# Author: Kevin_Tellez_2194683_Daniel_Sarmiento_2202797_E1B_G2
...
class pregunta_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "pregunta_1")
...
def main(top_block_cls=pregunta_1, options=None):
